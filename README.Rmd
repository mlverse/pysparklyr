...
Integrates `sparklyr` with PySpark and Databricks. The main reson of this package is because the new Spark and Databricks Connect connection method does
...
- [ ] Implement `invoke_new()` method for `pysparklyr_connection`. Initial implmentation is available, but more testing is needed.
